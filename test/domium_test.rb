...
describe Domium do
  ...
  #     @domium.has_responsive_delivery?("http://www.forever21.com/UK/Product/Main.aspx?br=f21").must_equal true
  #   end

  #   it "must not say sites that don't have responsive delivery do" do
  #     @domium.has_responsive_delivery?("http://www.engadget.com/").must_equal false
  #   end
  # end
